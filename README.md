# ZhuaTech Marketing｜知华科技营销自动化与客户旅程系统
        ...
        在原有四大业务模块基础上，新增企业控制中心：支持组织与账期维度、幂等防重、经办/管理员职责分离、审批闭环、附件 SHA-256 元数据、办结凭证门槛、外部适配器回执、乐观锁和全程审计；并实现营销授权、退订抑制、渠道完整性、频控与转化收益预测。详见[企业版能力说明](docs/ENTERPRISE.md)。
